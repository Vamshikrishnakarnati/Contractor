...
<html lang="en">
<head>
    <title><?=$ProjectName;?> | <?php if($passurl == "reset-password") { echo $ResetPassword; } if($passurl == "create-password") { echo $CreatePassword; } ?></title>
    <meta charset="utf-8" />
                            ...
                            <div class="col-sm-6 col-lg-5 col-xxl-3  align-self-center order-2 order-sm-1">
                                <div class="d-flex align-items-center h-100-vh">
                                    <div class="login p-50">
                                        ...
                                        <p><?php if($passurl == "reset-password") { echo $ResetPassword; } if($passurl == "create-password") { echo $CreatePassword; } ?></p>
										<?php  
										...
										?>
                                       <form action="" method="post" id="resetForm" role="form" autocomplete="off">
                                            <div class="row mt-3">
                                                <div class="col-12">
													<div class="form-group">
													   <label for="new_password" class="control-label"><?=$NewPassword;?></label>
													  <input type="password" class="form-control" name="new_password" id="new_password" placeholder="Enter new password" maxlength="50">
													</div>
													<div class="form-group">
														<label for="confirm_password" class="control-label"><?=$ConfirmPassword;?></label>
                                                ...
                                                <div class="col-12 mt-3">
                                                    <button type="submit" name="submit" value="reset" class="btn btn-primary text-uppercase"><?=$BTN_Submit;?></button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
