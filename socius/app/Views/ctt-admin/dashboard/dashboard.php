...
$QsSettings = $this->admin->retrive_all_cond_data('*',tbl_setting,'is_active = 1', 'id','ASC');
$QsParameter = $this->admin->retrive_all_cond_data('*',tbl_parameter,'is_active = 1', 'id','ASC');
 ?>               <!-- begin app-main -->
                    ...
                    <div class="container-fluid">
                                    ...
                                    <div class="ml-auto d-flex align-items-center">
                                        <nav>
                                            <ol class="breadcrumb p-0 m-b-0">
                                                ...
                                                <li class="breadcrumb-item active text-primary" aria-current="page"><?=$ProjectName;?></li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
						...
						<div class="row">
                            <div class="col-xs-12 col-xxl-3 m-b-30">
                               <h2 class="text-black mb-0">Comming Soon.....</h2>
                            </div>
                        </div>
                        <!-- end row -->
                       ...
                       <!-- <div class="row">
                            <div class="col-xs-6 col-xxl-3 m-b-30">
                                <div class="card card-statistics h-100 m-b-0 bg-success">
                                    <div class="card-body">
                                        <h2 class="text-white mb-0">60</h2>
                                        <p class="text-white">Certified Diamonds</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-6 col-xxl-3 m-b-30">
                            ...
                            <div class="col-xs-6 col-xxl-3 m-b-30">
                                <div class="card card-statistics h-100 m-b-0 bg-info">
                                    <div class="card-body">
                                        <h2 class="text-white mb-0">20</h2>
                                        <p class="text-white">Certified Diamonds</p>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="card-body pb-0">
                                        <div class="row">
                                            <div class="col-xxs-6 col-md-4">
                                                <h5 class="mb-1 text-pink">Monthly income</h5>
                                                <p>18% High Then Last Month</p>
                                            </div>
                                            <div class="col-xxs-6 col-md-4">
                                                <h5 class="mb-1 text-primary">Yearly income</h5>
                                                <p>26% High Then Last Year</p>
                                            </div>
                                        </div>
                            ...
                            <div class="col-xxl-6 m-b-30">
                                <div class="card card-statistics h-100 mb-0">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title">Income by plans</h4>
                                        <div class="row">
                                            <div class="col-12 col-xs-3">
                                                <span>Membership Plan1: <b>$1,475</b></span>
                                                <div class="progress my-3" style="height: 4px;">
                                                    <div class="progress-bar" role="progressbar" style="width: 80%;" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                            </div>
                                            <div class="col-12 col-xs-3">
                                                <span>Membership Plan2: <b>$23,475</b></span>
                                                <div class="progress my-3" style="height: 4px;">
                                                    <div class="progress-bar bg-success" role="progressbar" style="width: 66%;" aria-valuenow="66" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                            </div>
                                            <div class="col-12 col-xs-3">
                                                <span>Membership Plan3: <b>$1,658</b></span>
                                                <div class="progress my-3" style="height: 4px;">
                                                    <div class="progress-bar bg-danger" role="progressbar" style="width: 78%;" aria-valuenow="78" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                            </div>
                                            <div class="col-12 col-xs-3">
                                                <span>Membership Plan1: <b>$12,489</b></span>
                                                <div class="progress my-3" style="height: 4px;">
                        ...
                        <div class="row">
                                    ...
                                    <div class="card-header bg-gradient">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-12 col-sm-6 text-center mt-3 mt-sm-0 text-sm-right">
                                                ...
                                                <span class="text-white">Join as a Member</span>
                            ...
                            <div class="col-xxl-8 m-b-30">
                                <div class="card card-statistics h-100 m-b-0">
                                    <div class="card-header d-flex justify-content-between">
                                        <div class="card-heading">
                                            <h4 class="card-title">Recently added member </h4>
                                        </div>
                                        <div class="dropdown">
                                            <a class="p-2" href="#!" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                <i class="fe fe-more-horizontal"></i>
                      ...
                      <!--  <div class="row">
                                    ...
                                    <div class="card-header d-block d-sm-flex align-items-center justify-content-between p-3">
                                        ...
                                        <div class="dropdown">
                                            <ul class="nav nav-tabs mb-0" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link py-2 active show" id="sell-02-tab" data-toggle="tab" href="#sell-02" role="tab" aria-controls="sell-02" aria-selected="true">Free</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link py-2" id="rent-02-tab" data-toggle="tab" href="#rent-02" role="tab" aria-controls="rent-02" aria-selected="false">Paid </a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-6 col-xxl-3 m-b-30">
                                <div class="card card-statistics h-100 mb-0">
                                    <div class="card-header d-flex justify-content-between">
                                        <div class="card-heading">
                                            <h4 class="card-title">Membership Activity</h4>
                                        </div>
                                        <div class="dropdown">
                                            <a class="p-2" href="#!" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                <i class="fe fe-more-horizontal"></i>
