...
(function(window, document, $, undefined){
    ...
    $(function(){
        ...
        if (dataTable.length > 0) {
            $('#datatable').DataTable({
				/* dom:"<'row'<'col-sm-12 col-md-6'l B><'col-sm-12 col-md-6 align-self-end'f>>" +"<'row'<'col-sm-12'tr>>" +"<'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7'p>>", */
                "bLengthChange": false,
                "searching": false,
                "bPaginate":false,
                "bSortable": true,
				...
				"buttons": 
				{
					buttons: [
						{
							extend: 'copy',
							text: '<strong><i class="fa fa-copy fa-x5"></i> Copy</strong>',
							titleAttr: 'Copy',
						...
						{
							extend: 'excel',
							text: '<strong><i class="fa fa-file-text-o fa-x5"></i> Excel</strong>',
							titleAttr: 'Excel',
							className: 'btn-primary',
							exportOptions: {
								columns: ':visible:not(.notexport)',
						...
						{
							extend: 'csv',
							text: '<strong><i class="fa fa-file-text-o fa-x5"></i> CSV</strong>',
							titleAttr: 'CSV',
							className: 'btn-primary',
							exportOptions: {
								columns: ':visible:not(.notexport)',
						...
						{
							extend: 'pdf',
							text: '<strong><i class="fa fa-file-pdf-o fa-x5"></i> PDF</strong>',
							titleAttr: 'PDF',
							className: 'btn-primary',
							exportOptions: {
								columns: ':visible:not(.notexport)',
						...
						{
							extend: 'print',
							text: '<strong><i class="fa fa-print fa-x5"></i> Print</strong>',
							titleAttr: 'Print',
							className: 'btn-primary',
							exportOptions: {
								columns: ':visible:not(.notexport)',
						...
						{
							extend: 'colvis',
							text: '<strong> Column Visibility</strong>',
							className: 'btn-primary',
							postfixButtons: [
								{
